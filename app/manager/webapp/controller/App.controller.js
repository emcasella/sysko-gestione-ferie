sap.ui.define(["sap/ui/core/mvc/Controller"], function (Controller) {
  ...
  return Controller.extend("sysko.ferie.manager.controller.App", {
        ...
        '<div id="sk-sidebar" class="sk-sidebar">' +
          '<div class="sk-sidebar-logo">' +
            ...
            '<div class="sk-logo-text">' +
              ...
              '<span class="sk-logo-sub">Gestione Ferie</span>' +
            '</div>' +
          '</div>' +
          '<nav class="sk-nav">' +
            '<a class="sk-nav-item" data-route="dashboard">' +
            ...
            '<a class="sk-nav-item" data-route="calendario">' +
              ...
              '</svg>Calendario' +
            '</a>' +
            '<a class="sk-nav-item" data-route="matrice">' +
              '<svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">' +
              ...
              '</svg>Matrice' +
            '</a>' +
            '<a class="sk-nav-item" data-route="sovrapposizioni">' +
              '<svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">' +
          ...
          '<div class="sk-sidebar-footer">' +
            ...
            '<div class="sk-user-info">' +
              ...
              '<span class="sk-user-role">Manager</span>' +
            '</div>' +
